...
VALUES (
  ...
  '{
    ...
    "B": {
      "first_message": "¡Hola psicólogo/a! 👋 Tenemos +100 evaluaciones validadas y reportes con IA. ¿Quieres probar 7 días gratis sin tarjeta, agendar una demo en vivo con Osvaldo, o que te cuente más?"
    }
  }'::jsonb,
  50
)
