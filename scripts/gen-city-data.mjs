...
const groups = [
  ...
  { aliases: ['mexicali','tijuana','ensenada','rosarito','tecate'], timezone: 'America/Tijuana', country: 'México', label: 'hora Pacífico', city: 'Mexicali' },
  { aliases: ['cancun','playa del carmen','tulum','cozumel','isla mujeres'], timezone: 'America/Cancun', country: 'México', label: 'hora Cancún', city: 'Cancún' },
  { aliases: ['hermosillo','sonora','ciudad obregon','guaymas','navojoa'], timezone: 'America/Hermosillo', country: 'México', label: 'hora Sonora', city: 'Hermosillo' },
  { aliases: ['chihuahua','juarez','ciudad juarez','delicias','parral'], timezone: 'America/Chihuahua', country: 'México', label: 'hora Chihuahua', city: 'Chihuahua' },
  { aliases: ['monterrey','saltillo','torreon','monclova','piedras negras','nuevo laredo','reynosa','matamoros'], timezone: 'America/Monterrey', country: 'México', label: 'hora Monterrey', city: 'Monterrey' },
  { aliases: ['guadalajara','puerto vallarta','leon','queretaro','puebla','merida','oaxaca','veracruz','acapulco','mazatlan','morelia','aguascalientes','san luis potosi','pachuca','toluca','cuernavaca','tlaxcala','tepic','colima','villahermosa','tuxtla gutierrez','campeche','chetumal','chilpancingo','durango','zacatecas'], timezone: 'America/Mexico_City', country: 'México', label: 'hora CDMX', city: 'Guadalajara' },
  ...
  { aliases: ['lima','arequipa','trujillo','cusco','chiclayo','piura','iquitos','huancayo','tacna','ica','puno','chimbote','ayacucho','cajamarca','pucallpa','huaraz','tumbes'], timezone: 'America/Lima', country: 'Perú', label: 'hora Lima', city: 'Lima' },
...
const extra = {
  'America/Mexico_City': { country: 'México', label: 'hora CDMX', cities: ['apizaco','atlixco','campeche city','celaya','cholula','ciudad valles','coatzacoalcos','comitan','cordoba mexico','cosamaloapan','cuautla','cuautitlan','ecatepec','fresnillo','guanajuato','huajuapan','huatulco','irapuato','ixtapa','ixtlahuaca','jilotepec','jiutepec','jojutla','la piedad','lazaro cardenas','linares','los mochis','manzanillo','matamoros tamaulipas','minatitlan','miramar','moroleon','naucalpan','nogales sonora','ocotlan','ocoyoacac','ometepec','orizaba','poza rica','progreso','puerto escondido','puerto penasco','salamanca mexico','san cristobal de las casas','san juan del rio','san luis rio colorado','san martin texmelucan','santa catarina','santa rosa jauregui','silao','tapachula','tehuacan','tehuantepec','temixco','tenancingo','texcoco','tlalnepantla','tlaxcoapan','tula de allende','uruapan','xalapa','zacapoaxtla','zacatepec','zamora mexico','zihuatanejo','zinacantepec'] },
